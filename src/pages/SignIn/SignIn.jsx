...
import { loginUser, getUserProfile, ensureProfileForCurrentUser } from "../../utils/supabaseUtils"
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (profile) {
        ...
        navigate(after ? "/profile" : "/Formulary");
      }
    } catch (e) {
        ...
        <div className="w-1/2 h-full flex flex-col justify-center items-center gap-12 box-content">
          ...
          <div className="w-full flex flex-col justify-center items-center gap-4">
            ...
            <div className="flex flex-row justify-between items-center w-8/12 my-2">
              <a
                href="#"
                className="underline text-xs text-(--color-elementos-claros)"
              >
